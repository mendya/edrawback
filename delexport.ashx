...
Public Class delimport : Implements IHttpHandler
    ...
    Public Sub ProcessRequest(ByVal context As HttpContext) Implements IHttpHandler.ProcessRequest
        ...
        Dim exportdate As String = json.Split("|")(2)
        ...
        Using connection As New SqlConnection(connectionString)
            Try
                connection.Open()
                Using Command As New SqlCommand("Delete from export where company=@company and style=@style and sizecolor=@sizecolor and export_date=@export_date;", connection)
