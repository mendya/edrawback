var _dwtParam = {
    'productKey': 'BAA6BAE61DB46EA8DD840C8784847C60B991DB9EDC55842BBC8E5A940B584F5510000000',
...
function btnUpload_onclick() {
     ...
     if (DWObject) {
        ...
        // varFileName.className = "";
         ...
         strHTTPServer = location.hostname; // document.getElementById("txtHTTPServer").value;
         DWObject.HTTPPort = 80; // document.getElementById("txtHTTPPort").value;
       //  var varUserName = document.getElementById("txtUserName");
         ...
         //    }        
         //}
         strActionPage = "/SaveToFile.aspx"; // document.getElementById("txtActionPage").value; //the ActionPage's file path
         strImageType = 4;
         //for (i = 0; i < 4; i++) {
