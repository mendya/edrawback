...
Partial Class Pending
    ...
    Protected Sub Page_Load(sender As Object, e As EventArgs) Handles Me.Load
        ...
        End If
        Pending.RootPath = ConfigurationManager.AppSettings.Item("RootPath") & UserCookie("UserName")

        If Not Page.IsPostBack Then
            Pending.CurrentLocation = Pending.RootPath
            If Not Directory.Exists(Pending.RootPath) Then
                Directory.CreateDirectory(Pending.RootPath)
            End If
    ...
    Private Sub ShowFolderItems()
        ...
        End If
        gvFileSystem.DataSource = OCDIOObject.GetAllPendingItemsInTheDirectory(Pending.CurrentLocation, Request.Cookies("Edrawbacks_UserInfo")("UserName"))
        gvFileSystem.DataBind()
    End Sub
    Private Sub ShowCurrentLocation()
        Try
            Dim strArrayLocation As String() = Pending.CurrentLocation.Replace(Pending.RootPath, "Root").Split(New Char() {"\"c})
    ...
    Protected Sub lbtnFolder_Click(ByVal sender As Object, ByVal e As EventArgs)
        Pending.CurrentLocation = DirectCast(sender, LinkButton).ToolTip.Replace("Root", Pending.RootPath)
        ...
        If ((e.Row.RowType = DataControlRowType.DataRow) AndAlso ( _
            ...
            If DirectCast(e.Row.Cells.Item(6).FindControl("chbx"), CheckBox).Checked Then
                ...
                Else
                    ...
                    e.Row.Cells(6).ToolTip = "Completed"
                End If
            Else
    ...
    Protected Sub btnSubmit_Click(sender As Object, e As EventArgs) Handles btnSubmit.Click
        ...
        gvFileSystem.DataSource = _
            OCDIOObject.GetAllItemsInTheDirectory(Pending.RootPath, txtFilter.Text, Request.Cookies("Edrawbacks_UserInfo")("UserName"))
        gvFileSystem.DataBind()
    End Sub
