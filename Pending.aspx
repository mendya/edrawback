<%@ Page Language="VB" AutoEventWireup="false" CodeFile="Pending.aspx.vb" Inherits="Pending" MasterPageFile="~/MasterPage.master" MaintainScrollPositionOnPostback="true" %>
                    ...
                    <asp:GridView ID="gvFileSystem" runat="server" AutoGenerateColumns="False"
                        ...
                        <Columns>
                            ...
                            <asp:TemplateField HeaderText="Status">
                                <ItemTemplate>
                                    <asp:CheckBox runat="server" ID="chbx" EnableViewState="true"  Checked='<%# Convert.ToBoolean(Eval("Approved")) %>' />
                                </ItemTemplate>
                            </asp:TemplateField>
